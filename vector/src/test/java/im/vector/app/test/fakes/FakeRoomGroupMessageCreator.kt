...
class FakeRoomGroupMessageCreator {
    ...
    fun givenCreatesRoomMessageFor(
            ...
            useCompleteNotificationFormat: Boolean = true
    ): RoomNotification.Message {
        val mockMessage = mockk<RoomNotification.Message>()
        every { instance.createRoomMessage(events, roomId, userDisplayName, userAvatarUrl, useCompleteNotificationFormat) } returns mockMessage
        return mockMessage
    }
}
