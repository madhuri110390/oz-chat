...
internal class VectorSettingsPushRuleNotificationViewModelTest {
    ...
    fun `given a ruleId, when the rule is checked or unchecked with no error, then the expected view event is posted`() = runTest {
        ...
        coVerifyOrder {
            // first rule id
            fakePushRuleService.updatePushRuleActions(any(), match { it.ruleId == firstRuleId }, any(), any())
            fakePushRuleService.updatePushRuleActions(any(), match { it.ruleId == RuleIds.RULE_ID_POLL_START_ONE_TO_ONE }, any(), any())
            fakePushRuleService.updatePushRuleActions(any(), match { it.ruleId == RuleIds.RULE_ID_POLL_START_ONE_TO_ONE_UNSTABLE }, any(), any())
            fakePushRuleService.updatePushRuleActions(any(), match { it.ruleId == RuleIds.RULE_ID_POLL_END_ONE_TO_ONE }, any(), any())
            fakePushRuleService.updatePushRuleActions(any(), match { it.ruleId == RuleIds.RULE_ID_POLL_END_ONE_TO_ONE_UNSTABLE }, any(), any())

            // second rule id
            fakePushRuleService.updatePushRuleActions(any(), match { it.ruleId == secondRuleId }, any(), any())
            fakePushRuleService.updatePushRuleActions(any(), match { it.ruleId == RuleIds.RULE_ID_POLL_START }, any(), any())
            fakePushRuleService.updatePushRuleActions(any(), match { it.ruleId == RuleIds.RULE_ID_POLL_START_UNSTABLE }, any(), any())
            fakePushRuleService.updatePushRuleActions(any(), match { it.ruleId == RuleIds.RULE_ID_POLL_END }, any(), any())
            fakePushRuleService.updatePushRuleActions(any(), match { it.ruleId == RuleIds.RULE_ID_POLL_END_UNSTABLE }, any(), any())
        }
