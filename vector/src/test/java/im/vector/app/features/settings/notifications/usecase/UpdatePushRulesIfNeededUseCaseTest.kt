...
internal class UpdatePushRulesIfNeededUseCaseTest {
    ...
    fun test() = runTest {
        ...
        coVerifySequence {
            ...
            // first set
            fakeSession.fakePushRuleService.updatePushRuleActions(any(), match { it.ruleId == RuleIds.RULE_ID_POLL_START_ONE_TO_ONE }, firstParentEnabled, firstParentActions)
            fakeSession.fakePushRuleService.updatePushRuleActions(any(), match { it.ruleId == RuleIds.RULE_ID_POLL_START_ONE_TO_ONE_UNSTABLE }, firstParentEnabled, firstParentActions)
            fakeSession.fakePushRuleService.updatePushRuleActions(any(), match { it.ruleId == RuleIds.RULE_ID_POLL_END_ONE_TO_ONE }, firstParentEnabled, firstParentActions)
            // second set
            fakeSession.fakePushRuleService.updatePushRuleActions(any(), match { it.ruleId == RuleIds.RULE_ID_POLL_START }, secondParentEnabled, secondParentActions)
            fakeSession.fakePushRuleService.updatePushRuleActions(any(), match { it.ruleId == RuleIds.RULE_ID_POLL_END }, secondParentEnabled, secondParentActions)
            fakeSession.fakePushRuleService.updatePushRuleActions(any(), match { it.ruleId == RuleIds.RULE_ID_POLL_END_UNSTABLE }, secondParentEnabled, secondParentActions)
        }
    }
