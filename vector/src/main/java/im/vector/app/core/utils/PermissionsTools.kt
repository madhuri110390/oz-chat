...
//when user connect headset & disconnect its required***
val PERMISSIONS_FOR_AUDIO_IP_CALL = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
    listOf(Manifest.permission.RECORD_AUDIO, Manifest.permission.BLUETOOTH_CONNECT)
} else {
    listOf(Manifest.permission.RECORD_AUDIO)
}
val PERMISSIONS_FOR_VIDEO_IP_CALL = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
    listOf(Manifest.permission.RECORD_AUDIO, Manifest.permission.CAMERA, Manifest.permission.BLUETOOTH_CONNECT)
} else {
