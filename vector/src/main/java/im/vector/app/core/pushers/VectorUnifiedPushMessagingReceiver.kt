                        ...
                        unifiedPushHelper.getPushGateway()?.let {
                            coroutineScope.launch {
                                try {
                                    ...
                                    // Active session may disappear between `hasActiveSession()` and this call.
                                    // Avoid crashing the process from an unhandled coroutine exception.
                                    Timber.tag(loggerTag.value).e(e, "Failed to register pusher from UnifiedPush onNewEndpoint")
                                }
                            }
                        }
                    }
