...
import im.vector.app.features.home.callhometab.CallHomeViewModel
...
interface MavericksViewModelModule {
    ...
    @Binds
    @IntoMap
    @MavericksViewModelKey(CallHomeViewModel::class)
    fun callHomeViewModelFactory(factory: CallHomeViewModel.Factory): MavericksAssistedViewModelFactory<*, *>
