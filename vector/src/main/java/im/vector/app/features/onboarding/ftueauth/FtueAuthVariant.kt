...
//                )
            ...
            is OnboardingViewEvents.OnForgetPasswordClicked -> {
                openUrlInChromeCustomTab(activity, null, "https://openzippers.com/forgot-password")
//                Toast.makeText(
//                        activity,
//                        "Check your email to reset your password, then log in with your new password.",
//                        Toast.LENGTH_LONG
//                ).show()
            }
//                when {
...
//                }
            ...
            is OnboardingViewEvents.OpenExternalUrl -> {
                openUrlInChromeCustomTab(activity, null, viewEvents.url)
            }
            else -> {}
        }
    }
