...
class RoomListFragment :
        ...
        roomListViewModel.sections.forEachIndexed { index, section ->
            ...
            val contentAdapter =
                    when {
                        ...
                        section.liveUsers != null -> {
                            pagedControllerFactory.createRoomListUserController()
                                    .also { controller ->
                                        section.liveUsers.observe(viewLifecycleOwner) { list ->
    ...
    override fun onUserClicked(user: User) {
        roomListViewModel.handle(RoomListAction.SelectUserDirectRoom(user))
    }
}
