...
class AttachmentTypeSelectorView(
    ...
    init {
        ...
        views.attachmentVideoButton.configure(AttachmentType.VIDEO_CAMERA)
    ...
    fun setAttachmentVisibility(type: AttachmentType, isVisible: Boolean) {
        when (type) {
            ...
            AttachmentType.VIDEO_CAMERA -> views.attachmentVideoButton
    ...
    private companion object {
        private val attachmentTooltipLabels: Map<AttachmentType, Int> = AttachmentType.values().associateWith {
            when (it) {
                ...
                AttachmentType.VIDEO_CAMERA -> CommonStrings.tooltip_attachment_video
