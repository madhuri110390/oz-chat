...
import im.vector.app.features.userdirectory.UserDirectoryUserItem_
...
class RoomSummaryItemFactory @Inject constructor(
    ...
    fun createUser(
        ...
        return UserDirectoryUserItem_()
                .id(user.userId)
                .matrixItem(user.toMatrixItem())
                .avatarRenderer(avatarRenderer)
                .clickListener { _ : android.view.View -> listener?.onUserClicked(user) }
    }
    ...
    fun createSuggestion(
        ...
        return SpaceChildInfoItem_()
                ...
                .buttonClickListener { _ : android.view.View -> listener?.onJoinSuggestedRoom(spaceChildInfo) }
                .itemClickListener { _ : android.view.View -> listener?.onSuggestedRoomClicked(spaceChildInfo) }
    }
    ...
    private fun createInvitationItem(
        ...
        val inviterName = roomSummary.inviterId?.removePrefix("@")?.substringBefore(":")
        ...
        return RoomInvitationItem_()
                ...
                .avatarRenderer(avatarRenderer)
                .matrixItem(if (roomSummary.isDirect && roomSummary.directUserId != null) MatrixItem.UserItem(roomSummary.directUserId!!, roomSummary.displayName, roomSummary.avatarUrl) else roomSummary.toMatrixItem())
                .secondLine(secondLine)
                .changeMembershipState(changeMembershipState)
                .acceptListener { _ : android.view.View -> listener?.onAcceptRoomInvitation(roomSummary) }
                .rejectListener { _ : android.view.View -> listener?.onRejectRoomInvitation(roomSummary) }
                .listener { _ : android.view.View -> listener?.onRoomClicked(roomSummary) }
    }
    ...
    private fun createRoomSummaryItem(
            ...
            .itemLongClickListener { _ : android.view.View -> onLongClick?.invoke(roomSummary) ?: false }
            .itemClickListener { _ : android.view.View -> onClick?.invoke(roomSummary) }
