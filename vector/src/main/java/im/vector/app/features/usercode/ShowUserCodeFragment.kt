...
class ShowUserCodeFragment :
    ...
    override fun invalidate() = withState(sharedViewModel) { state ->
        ...
        val bestName = state.matrixItem?.displayName ?: state.matrixItem?.id?.removePrefix("@")?.substringBefore(":")
        views.showUserCodeCardNameText.setTextOrHide(bestName)
        views.showUserCodeCardUserIdText.visibility = View.GONE
    }
}
