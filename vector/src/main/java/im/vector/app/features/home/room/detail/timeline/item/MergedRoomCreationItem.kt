...
abstract class MergedRoomCreationItem : BasedMergedItem<MergedRoomCreationItem.Holder>(R.layout.item_timeline_event_base_noinfo) {
    ...
    private fun bindMergedViews(holder: Holder) {
        // Hide the merged events row (system messages like "joined / invited") along with its separator.
        holder.mergedView.visibility = View.GONE
        holder.summaryView.visibility = View.GONE
        holder.avatarView.visibility = View.GONE
        holder.encryptionTile.visibility = View.GONE
        holder.view.findViewById<View>(R.id.itemMergedSeparatorView)?.visibility = View.GONE
    }
...
//        }
    ...
    private fun bindCreationSummaryTile(holder: Holder) {
        // Hide the entire "beginning of message history" tile so it never appears in chat.
        holder.view.findViewById<androidx.constraintlayout.widget.ConstraintLayout>(R.id.creationTile)?.visibility = View.GONE
        return
