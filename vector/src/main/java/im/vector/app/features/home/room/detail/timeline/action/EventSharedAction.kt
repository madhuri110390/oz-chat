...
sealed class EventSharedAction(
    ...
    data class DeleteForMe(
            val eventId: String,
            val dialogTitleRes: Int = CommonStrings.delete_for_me_dialog_title,
            val dialogDescriptionRes: Int = CommonStrings.delete_for_me_dialog_content
    ) : EventSharedAction(CommonStrings.delete_for_me_action, R.drawable.ic_trash, true)
