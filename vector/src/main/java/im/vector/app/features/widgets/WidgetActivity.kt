...
class WidgetActivity : VectorBaseActivity<ActivityWidgetBinding>() {
    ...
    companion object {
        ...
        fun getOutput(intent: Intent): Content? {
            return intent.extras?.getSerializableCompat<Serializable>(EXTRA_RESULT) as? Content
        }
    ...
    private fun createElementCallPipParams(): PictureInPictureParams? {
        ...
        val pendingIntent = PendingIntent.getBroadcast(this, REQUEST_CODE_HANGUP, intent, PendingIntentCompat.FLAG_IMMUTABLE)
