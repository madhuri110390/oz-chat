...
//        }
//        holder.creatorNameView.text = attributes.userOfInterest.getBestName() ?.removePrefix("@")
//                ?.substringBefore(":")
//                ?: ""
...
//    }
    override fun bind(holder: Holder) {
        ...
        // Get the user ID (e.g. "@john:matrix.org") and extract the local part
        val userId = attributes.userOfInterest.id
        val username = userId?.removePrefix("@")?.substringBefore(":") ?: ""
        holder.creatorNameView.text = username
