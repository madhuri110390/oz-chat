    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        session.userService().getUserLive(session.myUserId).observeK(viewLifecycleOwner) { optionalUser ->
            ...
            if (user != null) {
                ...
                views.homeDrawerUsernameView.text = username
                views.homeDrawerUsernameView.visibility = View.VISIBLE
                views.homeDrawerUserIdView.visibility = View.GONE
            }
        }
        // Profile
        ...
        views.homeDrawerInviteFriendButton.debouncedClicks {
            InviteFriendsBottomSheet.show(parentFragmentManager)
        }
