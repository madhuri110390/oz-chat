...
class AudioMessageHelper @Inject constructor(
    ...
    fun stopRecording(): MultiPickerAudioType? {
        ...
        voiceMessageFile?.parentFile?.let { dir ->
        ...
        return try {
            voiceMessageFile?.let {
                val outputFileUri = FileProvider.getUriForFile(context, buildMeta.applicationId + ".fileProvider", it, ".voice_message.${it.extension}")
