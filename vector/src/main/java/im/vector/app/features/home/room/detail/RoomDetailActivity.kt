...
class RoomDetailActivity :
    ...
    private lateinit var timelineArgs: TimelineArgs
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            ...
            controller?.apply {
                // Ensure light or dark icons depending on your background
       ...
       // val timelineArgs: TimelineArgs = intent?.extras?.getParcelableCompat(EXTRA_ROOM_DETAIL_ARGS) ?: return
        timelineArgs = intent?.extras?.getParcelableCompat(EXTRA_ROOM_DETAIL_ARGS) ?: return
    ...
    override fun onPause() {
        super.onPause()
        // When the app goes to background, ensure we don't keep a stale "currently viewing room" value.
        // Otherwise incoming pushes for that room can be ignored/skipped.
