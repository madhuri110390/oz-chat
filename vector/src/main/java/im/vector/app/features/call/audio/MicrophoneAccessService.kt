...
class MicrophoneAccessService : VectorAndroidService() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        try {
            ...
            Timber.e(e, "MicrophoneAccessService: Failed to start foreground service. Permission or background restriction.")
            stopSelf()
            return START_NOT_STICKY
        } catch (e: Exception) {
            Timber.e(e, "MicrophoneAccessService: Unknown error starting foreground service.")
            stopSelf()
            return START_NOT_STICKY
        }
