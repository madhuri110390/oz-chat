...
//            is CreateDirectRoomAction.PrepareRoomWithSelectedUsers -> {
//                viewModelScope.launch {
//                    onSubmitInvitees(action.selections)
//                }
//            }
...
//     */
//    private suspend fun onSubmitInvitees(selections: Set<PendingSelection>) {
...
//    }
//
//    // Example of a proper suspend implementation
//
//
//    private fun onCreateRoomWithInvitees() {
//        withState { state ->
//            viewModelScope.launch {
//                createLocalRoomWithSelectedUsers(state.pendingSelections)
//            }
//        }
//    }
//
//    // BEFORE
//    private suspend fun createLocalRoomWithSelectedUsers(selections: Set<PendingSelection>) {
//        setState { copy(createAndInviteState = Loading()) }
//        val adminE2EByDefault = withContext(Dispatchers.IO) {
...
//            }
//        }
//        setState { copy(createAndInviteState = result) }
//    }
//}
...
class CreateDirectRoomViewModel @AssistedInject constructor(
     ...
     */
    private suspend fun onSubmitInvitees(selections: Set<PendingSelection>) {
        val existingRoomId = withContext(Dispatchers.IO) {
            selections.singleOrNull()?.getMxId()?.let { userId ->
                session.roomService().getExistingDirectRoomWithUser(userId)
            }
        }
        if (existingRoomId != null) {
