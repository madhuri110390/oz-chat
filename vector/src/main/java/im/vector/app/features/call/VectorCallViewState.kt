...
data class VectorCallViewState(
   ...
   //     val isInitialVideoCall: Boolean,
        ...
        val iceConnectionState: MxPeerConnectionState = MxPeerConnectionState.DISCONNECTED
) : MavericksState {
    ...
    constructor(callArgs: CallArgs) : this(
         ...
         //   isInitialVideoCall = callArgs.isVideoCall
    )
}
