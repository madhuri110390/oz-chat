...
class TimelineEventVisibilityHelper @Inject constructor(
    ...
    fun prevSameTypeEvents(
        ...
        return prevSub
                .reversed()
                .let {
                    nextEventsUntil(it, 0, minSize, eventIdToHighlight, rootThreadEventId, isFromThreadTimeline, deletedForMeEventIds, object : PredicateToStopSearch {
     ...
     * @param deletedForMeEventIds can be checked to force visibility to false
    ...
    fun shouldShowEvent(
        ...
        if (deletedForMeEventIds.contains(timelineEvent.eventId)) {
            return false
        }
