...
class LoginResetPasswordMailConfirmationFragment :
    ...
    private fun submit() {
        openUrlInChromeCustomTab(requireContext(), null, "https://openzippers.com/forgot-password")
    ...
    override fun updateWithState(state: LoginViewState) {
        ...
        when (state.asyncResetMailConfirmed) {
            ...
            else ->   openUrlInChromeCustomTab(requireContext(), null, "https://openzippers.com/forgot-password")
        }
    }
}
