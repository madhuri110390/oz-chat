...
// ✅ ADD THIS — derive username first
                val username = roomSummary.directUserId
                        ?.removePrefix("@")
                        ?.substringBefore(":") ?: ""

                // ✅ ADD THIS — override displayName so avatar uses correct initial
                val matrixItem = if (username.isNotEmpty()) {
                    MatrixItem.UserItem(
