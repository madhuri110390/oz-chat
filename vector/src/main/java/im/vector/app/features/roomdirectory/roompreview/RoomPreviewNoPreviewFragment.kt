...
class RoomPreviewNoPreviewFragment :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        views.roomPreviewNoPreviewJoin.commonClicked = ClickListener { roomPreviewViewModel.handle(RoomPreviewAction.Join) }
    }
                ...
                when (state.peekingState.invoke()) {
                    PeekingState.FOUND -> {
                        ...
                        if (state.fromEmailInvite != null && !state.isEmailBoundToAccount) {
                            ...
                            views.roomPreviewNoPreviewJoin.commonClicked = ClickListener {
