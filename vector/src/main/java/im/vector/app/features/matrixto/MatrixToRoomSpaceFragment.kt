...
//        views.matrixToCardMainButton.commonClicked = ClickListener { mainButtonClicked() }
//        views.matrixToCardSecondaryButton.commonClicked = ClickListener { secondaryButtonClicked() }
    }
