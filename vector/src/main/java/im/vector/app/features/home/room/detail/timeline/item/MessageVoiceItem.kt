...
abstract class MessageVoiceItem : AbsMessageItem<MessageVoiceItem.Holder>() {
    ...
    private fun onWaveformViewReady(holder: Holder) {
        holder.voicePlaybackLayout.isClickable = true
        holder.voicePlaybackLayout.isLongClickable = true

        holder.voiceLayout.isClickable = true
        holder.voiceLayout.isLongClickable = true
        holder.voicePlaybackLayout.setOnLongClickListener(attributes.itemLongClickListener)
        holder.voiceLayout.setOnLongClickListener(attributes.itemLongClickListener)
        ...
        holder.voicePlaybackLayout.setOnClickListener {
        ...
        holder.voicePlaybackWaveform.setOnTouchListener { view, motionEvent ->
            when (motionEvent.action) {
                ...
                MotionEvent.ACTION_DOWN -> {
                    // 👇 Allow parent to handle long press
                ...
                MotionEvent.ACTION_MOVE -> {
                    ...
                    // 👇 Now child takes control (for seeking)
