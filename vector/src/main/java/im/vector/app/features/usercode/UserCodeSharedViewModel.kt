...
class UserCodeSharedViewModel @AssistedInject constructor(
    ...
    init {
        ...
        val profileUrl = session.permalinkService().createPermalink(initialState.userId) ?: initialState.userId
        setState {
            copy(
    ...
    private fun handleShareByText() {
        ...
        val text = stringProvider.getString(CommonStrings.invite_friends_text, username)
        _viewEvents.post(
