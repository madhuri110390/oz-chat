...
class NotificationRenderer @Inject constructor(
    ...
    fun render(
        ...
        with(notificationFactory) {
            val roomNotifications = roomEvents.toNotifications(myUserDisplayName, myUserAvatarUrl, useCompleteNotificationFormat)
            ...
            roomNotifications.forEach { wrapper ->
                when (wrapper) {
                    ...
                    is RoomNotification.Message -> {
                        ...
                        notificationDisplayer.showNotificationMessage(wrapper.meta.roomId, ROOM_MESSAGES_NOTIFICATION_ID, wrapper.notification, wrapper.meta.roomId, currentRoomId)
                    }
                }
            }
            ...
            invitationNotifications.forEach { wrapper ->
                when (wrapper) {
                    ...
                    is OneShotNotification.Append -> {
                        ...
                        notificationDisplayer.showNotificationMessage(wrapper.meta.key, ROOM_INVITATION_NOTIFICATION_ID, wrapper.notification, wrapper.meta.key, currentRoomId)
                    }
                }
            }
            ...
            simpleNotifications.forEach { wrapper ->
                when (wrapper) {
                    ...
                    is OneShotNotification.Append -> {
                        ...
                        notificationDisplayer.showNotificationMessage(wrapper.meta.key, ROOM_EVENT_NOTIFICATION_ID, wrapper.notification, null, currentRoomId)
                    }
                }
            }
