...
class FontScalePreferencesImpl @Inject constructor(
    ...
    private val largeFontScaleValue = fontScaleValues[3]
    ...
    override fun getAppFontScaleValue(): FontScaleValue {
        return if (APPLICATION_FONT_SCALE_KEY !in preferences) {
            ...
            fontScaleValues.firstOrNull { it.preferenceValue == pref } ?: largeFontScaleValue
        }
    }
    ...
    override fun getUseSystemScale(): Boolean {
        return preferences.getBoolean(APPLICATION_USE_SYSTEM_FONT_SCALE_KEY, false)
    }
