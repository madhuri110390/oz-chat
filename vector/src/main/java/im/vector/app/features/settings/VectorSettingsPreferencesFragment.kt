...
class VectorSettingsPreferencesFragment :
    ...
    override fun bindPref() {
        ...
        findPreference<VectorSwitchPreference>(VectorPreferences.SETTINGS_SHOW_AVATAR_DISPLAY_NAME_CHANGES_MESSAGES_KEY)?.let { pref ->
            pref.isChecked = vectorPreferences.showAvatarDisplayNameChangeMessages()
            pref.setOnPreferenceChangeListener { _, newValue ->
                vectorPreferences.setAvatarDisplayNameChangeMessagesVisible(newValue as Boolean)
