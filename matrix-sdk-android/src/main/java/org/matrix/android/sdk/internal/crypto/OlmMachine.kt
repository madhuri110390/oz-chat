...
internal class OlmMachine @Inject constructor(
    ...
    suspend fun receiveSyncChanges(
        ...
        val response = withContext(coroutineDispatchers.io) {
            ...
            val receiveSyncChanges = inner.receiveSyncChanges(events, devices, counts, deviceUnusedFallbackKeyTypes, nextBatch ?: "", DecryptionSettings(TrustRequirement.UNTRUSTED))
