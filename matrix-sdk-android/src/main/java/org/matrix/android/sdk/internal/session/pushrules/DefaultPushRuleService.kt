...
internal class DefaultPushRuleService @Inject constructor(
    ...
    override suspend fun updatePushRuleActions(kind: RuleKind, pushRule: PushRule, enable: Boolean, actions: List<Action>?) {
        updatePushRuleActionsTask.execute(UpdatePushRuleActionsTask.Params(kind, pushRule, enable, actions))
    }
