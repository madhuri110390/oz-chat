...
interface SyncService {
    ...
    /**
     * Executes a one-time sync synchronously. Use this when you are holding a Wakelock
     * and need to fetch to-device messages immediately instead of relying on WorkManager.
     */
    suspend fun executeOneSync(timeoutSeconds: Long = 0)
